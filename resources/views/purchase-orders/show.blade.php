...
@section('content')
    <div>
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-xl font-semibold text-gray-900 dark:text-[var(--text-1)] prime:text-gray-900">FOR QUOTATION Details</h1>
                <p class="text-sm text-gray-500 dark:text-[var(--text-3)] prime:text-gray-500 mt-0.5">{{ $purchaseOrder->po_number }}</p>
            </div>
            <div class="flex items-center gap-3">
                <a href="{{ route('purchase-orders.download', $purchaseOrder) }}"
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tfoot>
                            <tr class="border-t-2 border-gray-200 dark:border-[var(--border)] prime:border-green-900">
                                <td @if($purchaseOrder->hide_price) colspan="3" @else colspan="4" @endif class="py-3 px-2 text-right font-semibold text-gray-900 dark:text-[var(--text-1)] prime:text-gray-900">Total Amount:</td>
                                @if(!$purchaseOrder->hide_price)
